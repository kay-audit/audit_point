 ...
 *
 * Сид идёт через модель (seedViolationBlocks): в блочной модели у пустого поля
 * нет ни одного rich-редактора — он живёт внутри блока, поэтому «дотянуться до
 * поверхности поля» до появления блоков нечем.
 *
