...
2. Если требование легитимное — увеличить лимит в `.env` и рестарт сервера. Помнить про `SECURITY__MAX_REQUEST_SIZE` (1 ГБ = 1073741824 байт дефолт) — он независимо ограничивает body запроса.
