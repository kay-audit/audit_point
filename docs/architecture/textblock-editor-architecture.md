...
растягивает, но на экспорт и на геометрию листа превью не влияет. Любое
...
Цена — лишний зазор до следующей строки после вложенной ветки (инлайн-блок
добавляет свой line box). Регрессия — сценарий «клик мышью правее конца
текста» в спеке 29.
