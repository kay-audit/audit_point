...
косметика: Enter порождает `<div>`, вставка из Word — `<p>`, внешняя
вставка приносит заголовки, и собственные отступы давали РАЗНЫЙ шаг в
зависимости от происхождения текста (замер: 34.4px против 18.4px, у
заголовков — до 40px), а у списков отступ вдобавок рос вместе с кеглем.
