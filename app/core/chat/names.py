...
TOOL_CREATE_ACT: Final[str] = "acts.create_act"
TOOL_ADD_PROCESSES_TO_ACT: Final[str] = "acts.add_processes_to_act"
TOOL_MODIFY_ACT_TREE: Final[str] = "acts.modify_act_tree"
