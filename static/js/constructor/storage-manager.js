...
export class StorageManager {
     ...
     *    у неё больше нет;
     *  - редактируемую ячейку таблицы (textarea в `.editing`): write-through
     *    (M.26) уже держит grid в синхроне на каждый input, коммит здесь лишь
     *    подстраховывает trim() и не трогает DOM/фокус (без blur — иначе
     *    автосейв рвал бы набор текста, см. commitPendingEdit).
